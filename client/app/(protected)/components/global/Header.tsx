...
export default function Header() {
  return (
    <>
      ...
      <header className="absolute inset-x-0 top-0 z-10 flex h-9 items-center justify-between border-b border-white/10 bg-zinc-950/32 px-3 text-[13px] font-medium text-white/90 shadow-lg shadow-black/10 backdrop-blur-xl sm:px-5">
